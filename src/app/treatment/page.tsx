...
export default function TreatmentPage() {
  ...
  if (!loaded) return <div className="max-w-3xl mx-auto px-6 py-10 text-muted-foreground">로딩 중...</div>;
      ...
      <Card className="border-primary/25 shadow-sm">
        ...
        <CardContent>
          <Textarea
            ...
            className="min-h-[400px] text-sm border-primary/25 focus:border-primary/25"
          />
        </CardContent>
      </Card>
    </div>
